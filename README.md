<h1 align="center">DDOS - DDoS Attack Script With 57 Methods</h1>
...
You can read it from [GitHub Wiki](https://github.com/pedrameyzd1/DDOS.git/wiki)

**Clone and Install Script**

```shell script
git https://github.com/pedrameyzd1/DDOS.git
cd DDOS
...
```shell script
apt -y update && apt -y install curl wget libcurl4 libssl-dev python3 python3-pip make cmake automake autoconf m4 build-essential git && git clone https://github.com/pedrameyzd1/DDOS.git && cd MH* && pip3 install -r requirements.txt
```
...
docker compose run -it --entrypoint /bin/bash DDOS

```


[python3]: https://python.org 'Python3'
[github issues]: https://github.com/pedrameyzd1/DDOS.git/issues 'enter'
